...
<body>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <a href="?page=buku_tambah" class="btn btn-primary mt-4">+ Tambah Buku</a>
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['deskripsi']; ?><td>
                                    ...
                                    <a href="?page=buku_ubah&&id=<?php echo $data['buku_id']; ?>"
                                        class="btn btn-info">Ubah</a>
                                    <a onclick="return confirm('Apakah anda yakin ingin menghapus ?');"
                                        href="?page=buku_hapus&&id=<?php echo $data['buku_id']; ?>"

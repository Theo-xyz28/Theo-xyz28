                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($data['status_peminjaman'] != 'dikembalikan') {
                                        ?>
                                        <a href="?page=peminjaman_ubah&id=<?php echo !empty($data['peminjaman_id']) ? $data['peminjaman_id'] : ''; ?>"
                                            class="btn btn-info">Ubah</a>
                                        <a onclick="return confirm('Apakah anda yakin ingin menghapus ?');"
                                            href="?page=peminjaman_hapus&id=<?php echo !empty($data['peminjaman_id']) ? $data['peminjaman_id'] : ''; ?>"
